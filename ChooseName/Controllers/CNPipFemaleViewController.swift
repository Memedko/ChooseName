//
//  CNPipFemaleViewController.swift
//  ChooseName
//
...
class CNPipFemaleViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        showPopup()
        if let lastName = UserDefaults.standard.value(forKey: Constants.savedFemaleLastName) as? String {
            textfieldLastName.text = lastName
        }
        if let secondName = UserDefaults.standard.value(forKey: Constants.savedFemaleFatherName) as? String {
    ...
    @IBAction func onSave(_ sender: Any?) {
        UserDefaults.standard.setValue(textfieldLastName.text, forKey: Constants.savedFemaleLastName)
        UserDefaults.standard.setValue(textfieldSecondName.text, forKey: Constants.savedFemaleFatherName)
...
extension CNPipFemaleViewController:UITextFieldDelegate {
